...
function maxOfTwoNumbers(num1, num2) {
  // TODO: to identify the largest number we need to compare them. if else statment is the right way to find it.
...
function findLongestWord(words) {
  // TODO: to find the the longest property in a array, we need to use forEach.
  //firsty set a varibel with an empty string. that will hold the longest word so far
  //them we have to compare those strings and return the longest word.
  //log the funktion and the parameter we looking for.
  let longestWord = "";
  words.forEach((word) => {
